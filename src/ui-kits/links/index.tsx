...
export const Links = ({ icon, path, title, open, onClick }: LinksProps) => {
    ...
    return (
        <Link
            ...
            className="flex items-center justify-start px-4 sm:px-6 py-5 gap-5 duration-300 text-gray-900 dark:text-white dark:hover:bg-white/20 hover:bg-gray-900/20"
        >
